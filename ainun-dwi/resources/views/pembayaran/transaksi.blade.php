            ...
            <tbody>
                @if ($pembayaran->count() == 0)
                    <tr class="text-center">
                        <td colspan="7"><b>Belum ada Transaksi</b></td>
                    </tr>
                @else
            ...
            <div class="modal-content">
                ...
                <form action="{{ url('pembayaran/simpan') }}" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="bi bi-x-circle mx-2"></i><b>Tutup</b></button>
