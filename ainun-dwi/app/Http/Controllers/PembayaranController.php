...
class PembayaranController extends Controller
{
    ...
    public function simpan(Request $request)
    {
        ...
        try {
          Pembayaran::create([
            ...
            return redirect()->back()->with('sukses', 'Transaksi Berhasil ditambahkan' );


        }catch(\Exception $e)
        {

            return redirect()->back()->with('gagal', 'Transaksi Gagal ditambahkan');
        }
    }
    // /////////////////////////edit
    ...
    public function edit($id)
    {
        try{
            ...
            return redirect('pembayaran')->with('gagal' ,'data gagal ditambahkan');
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        try{
            ...
            return redirect('pembayaran')->with('sukses' ,'data berhasil disimpan');
        }catch(\Exception $e){
            return redirect('pembayaran')->with('gagal' ,'data gagal disimpan');
        }
